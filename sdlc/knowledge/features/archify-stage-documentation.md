...
sources:
  ...
  - { id: plan, resource: sdlc/archify-stage-documentation/plan.md, last_modified: "2026-09-09T11:52:55+10:00", digest: 33eeb2d8d060ce0c }
---
...
- `commands/plan.md`
- `commands/test.md`
- `scripts/sdlc/cli.py` in [hooks.py](/modules/hooks-py.md)
...
- `scripts/sdlc/testing.py` in [hooks.py](/modules/hooks-py.md)
