...
type: Module
title: run
description: "Graphify community 71: scripts/sdlc/project.py, tests/conftest.py, tests/test_plan_design.py"
resource: ""
...
- run() (tests/conftest.py:L26)
- Invoke the CLI in-process; return its JSON result dict. (tests/conftest.py:L27)
