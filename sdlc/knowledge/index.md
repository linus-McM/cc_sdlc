...
* [build.py](modules/build-py.md) - Graphify community 9: scripts/sdlc/__init__.py, scripts/sdlc/build.py, scripts/sdlc/evals.py
...
* [conftest.py](modules/conftest-py.md) - Graphify community 86: tests/conftest.py
* [deploy.py](modules/deploy-py.md) - Graphify community 69: scripts/sdlc/deploy.py
* [Digests](modules/digests.md) - Graphify community 78: scripts/sdlc/knowledge.py
* [fail](modules/fail.md) - Graphify community 7: scripts/sdlc/project.py, scripts/sdlc/testing.py
...
* [run](modules/run.md) - Graphify community 82: tests/conftest.py, tests/test_plan_design.py
* [stages.py](modules/stages-py.md) - Graphify community 3: scripts/sdlc/artifacts.py, scripts/sdlc/knowledge.py, scripts/sdlc/project.py, scripts/sdlc/stages.py
* [test_artifacts.py](modules/test-artifacts-py.md) - Graphify community 81: tests/test_artifacts.py
* [test_build_test.py](modules/test-build-test-py.md) - Graphify community 87: tests/test_build_test.py
* [test_deploy.py](modules/test-deploy-py.md) - Graphify community 77: tests/conftest.py, tests/test_deploy.py
