...
* [fail](modules/fail.md) - Graphify community 9: scripts/sdlc/__init__.py, scripts/sdlc/build.py, scripts/sdlc/evals.py, scripts/sdlc/project.py
...
* [testing.py](modules/testing-py.md) - Graphify community 7: scripts/sdlc/testing.py
