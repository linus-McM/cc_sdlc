...
* [deploy.py](modules/deploy-py.md) - Graphify community 69: scripts/sdlc/deploy.py, scripts/sdlc/testing.py
...
* [knowledge.py](modules/knowledge-py.md) - Graphify community 77: scripts/sdlc/knowledge.py
...
* [read_json](modules/read-json.md) - Graphify community 82: scripts/sdlc/knowledge.py, scripts/sdlc/project.py
* [refresh](modules/refresh.md) - Graphify community 74: scripts/sdlc/knowledge.py
* [run](modules/run.md) - Graphify community 2: scripts/sdlc/__init__.py, tests/conftest.py, tests/test_build_test.py, tests/test_deploy.py, tests/test_plan_design.py
...
* [staleness](modules/staleness.md) - Graphify community 79: scripts/sdlc/knowledge.py
...
* [knowledge.py](hubs/knowledge-py.md) - Graphify god node with degree 100 in scripts/sdlc/knowledge.py
...
* [toml_config()](hubs/toml-config.md) - Graphify god node with degree 23 in tests/conftest.py
