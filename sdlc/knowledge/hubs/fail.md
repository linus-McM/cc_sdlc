...
type: Hub
title: fail()
description: Graphify god node with degree 49 in plugin/scripts/sdlc/project.py
...
# Where
- `plugin/scripts/sdlc/project.py:L94`

# Module
- [fail](/modules/fail.md)

# Why it matters
- degree 49: many modules reach this symbol; changes here have a wide blast radius
