...
type: Hub
title: refresh()
description: Graphify god node with degree 47 in plugin/scripts/sdlc/knowledge.py
resource: plugin/scripts/sdlc/knowledge.py
tags: [hub, graphify]
status: draft
...
# Where
- `plugin/scripts/sdlc/knowledge.py:L922`

# Module
- [refresh](/modules/refresh.md)

# Why it matters
- degree 47: many modules reach this symbol; changes here have a wide blast radius
