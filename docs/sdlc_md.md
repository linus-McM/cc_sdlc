...
* Category
  ...
  [Enterprise AI](https://claude.com/blog/category/enterprise-ai?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)

  [Claude Code](https://claude.com/blog/category/claude-code?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)
* Product

  [Claude Enterprise](https://claude.com/solutions/enterprise?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)

  [Claude Code](https://claude.com/product/claude-code?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)

  [Claude Tag](https://claude.com/product/tag?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)
* Date
...
Many engineering teams still have the same approval gates, reviews, handoffs, and policies, stalling productivity gains made by using agentic coding solutions like [Claude Code](https://claude.com/product/claude-code?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728).
...
Once approved by the product owner, Claude takes the accepted `intent.md` and produces a requirements and design spec. This is guided by the organization's [skills](https://code.claude.com/docs/en/skills?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728) for brand, security, compliance, and UX.
...
Front-end work is the clearest example. Once the `intent.md` is accepted, the product owner mocks the design up in [Claude Design](https://claude.com/product/design?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728) (beta) from the `intent.md`, iterates on the mock, and then exports it to Claude Code to build.
...
Engineers start Claude Code sessions in [plan mode](https://code.claude.com/docs/en/permission-modes?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728), give Claude the approved `spec.md` from Stage 2: Design, and let it interview them, iterating on the plan until the engineer is happy with it.
...
3. Put the skill in the repo at `.claude/skills/<name>/` so it ships with the code, or distribute it organization-wide through a [plugin](https://code.claude.com/docs/en/plugin-marketplaces?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728).
...
A skill is an advisory control while a [hook](https://code.claude.com/docs/en/hooks?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728) is the deterministic layer behind it. Most of Claude's actions are file edits and shell commands during implementation, so the build phase is where hooks can end up firing most often.
...
A parallel session is another full Claude Code instance, working a separate task in its own [git worktree](https://code.claude.com/docs/en/worktrees?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728). Each independent session knows nothing about the others, and the engineer steering them is the only thing they share.

A [subagent](https://code.claude.com/docs/en/sub-agents?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728) runs inside a single session as a scoped helper with its own context window and tool limits and suits jobs that recur in multiple tasks such as verifying the app runs as expected.
...
For how these controls compose at production scale, see [securing an AI-native SDLC at Anthropic](https://claude.com/blog/how-anthropic-secures-its-ai-native-software-development-lifecycle?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728).
...
A deterministic script watches production and invokes Claude when a control band is breached. Monitoring of a breach is a helpful example of the pattern for the loop running autonomously, while the [Claude Tag](https://claude.com/product/tag?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728) (public beta) section at the end of the stage covers work arriving through different channels.
...
[How Anthropic employees use Claude Tag](https://claude.com/blog/how-anthropic-employees-use-claude-tag?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)How Anthropic employees use Claude Tag
...
[The Claude Code guide for startups](https://claude.com/blog/claude-code-guide-for-startups?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)The Claude Code guide for startups
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/compliance-api-cowork-and-claude-code?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)Compliance API coverage extends to Claude Cowork and Claude Code
...
[Bain &amp; Company joins the Claude Partner Network as a Global Premier partner](https://claude.com/blog/bain-company-joins-the-claude-partner-network-as-a-global-premier-partner?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)Bain & Company joins the Claude Partner Network as a Global Premier partner

## Transform how your organization operates with Claude

See pricing

[See pricing](https://claude.com/pricing?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728#api)See pricing

Contact sales

[Contact sales](https://claude.com/contact-sales?utm_content=inline_link&utm_source=it&utm_medium=email&utm_campaign=2026_Q2_SS_MKTG_Dev_Newsletter_SEPT_V12&utm_term=claude_code&utm_campaignId=19714728)Contact sales
